create table decision_case (
    ...
    input_snapshot_version varchar(64),
...
create table evaluation_run (
    ...
    policy_input_version varchar(64) not null,
...
create table governance_event_quarantine (
    ...
    constraint ck_governance_event_quarantine_failure check (failure_code in (
        'MALFORMED_EVENT',
